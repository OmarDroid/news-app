package com.android.kotlin.newsappmvvm.ui.viewModels
...
import com.android.kotlin.newsappmvvm.NewsApplication
...
class NewsViewModel(
    ...
    init {
        getBreakingNews(NEWS_COUNTRY_CODE)
    }
    ...
    private fun hasInternetConnection(): Boolean {
        val connManager = getApplication<NewsApplication>().getSystemService(
